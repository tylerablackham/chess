...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_GREY = SET_BG_COLOR + "242m";
    public static final String SET_BG_COLOR_RED = SET_BG_COLOR + "160m";
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "76m";
    public static final String SET_BG_COLOR_DARK_GREEN = SET_BG_COLOR + "34m";
    public static final String SET_BG_COLOR_YELLOW = SET_BG_COLOR + "184m";
    public static final String SET_BG_COLOR_PINK = SET_BG_COLOR + "224m";
